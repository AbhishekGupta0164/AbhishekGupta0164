...
| [**AI Fairness Training Gym-FairForge Arena**](https://github.com/AbhishekGupta0164/GDP--Hackathon) | Detect, measure, fix & explain bias in AI models using RL (PPO) + Gemini AI. Built for **Google Solution Challenge 2026** ⭐2 🍴3 | `Python` `HTML` `Gemini AI` `PPO` | [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen?style=flat)](https://fair-forge-arena.vercel.app/) |
...
| [**AI Exam Anxiety Predictor**](https://github.com/AbhishekGupta0164/AI-Exam-Anxity-Prediction-Model) | Predicts student exam anxiety using a **BERT-based NLP model** trained on behavioral datasets | `Python` `BERT` `NLP` `Jupyter` | [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen?style=flat) |
